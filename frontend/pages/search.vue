<template>
  <section class="max-w-5xl mx-auto py-8 space-y-6">
    <header class="space-y-2">
      <h1 class="text-3xl font-bold text-stone-900">Full Search</h1>
      <p class="text-stone-600 text-sm">Search across programs, journal questions, and CMS pages.</p>
    </header>
    ...
    <form class="flex gap-2" @submit.prevent="runSearch">
      ...
      />
      <button type="submit" class="px-4 py-2 rounded-lg bg-stone-900 text-white hover:bg-black">Search</button>
    </form>
    ...
    <div class="grid gap-4 md:grid-cols-3">
      <article class="bg-white border border-stone-200 rounded-xl p-4">
        <h2 class="font-semibold text-stone-900 mb-2">Programs ({{ results.programs.length }})</h2>
      ...
      <article class="bg-white border border-stone-200 rounded-xl p-4">
        <h2 class="font-semibold text-stone-900 mb-2">Journal Questions ({{ results.journal_questions.length }})</h2>
        <ul class="space-y-2 text-sm">
      ...
      <article class="bg-white border border-stone-200 rounded-xl p-4">
        <h2 class="font-semibold text-stone-900 mb-2">CMS Pages ({{ results.cms_pages.length }})</h2>
        <ul class="space-y-2 text-sm">
