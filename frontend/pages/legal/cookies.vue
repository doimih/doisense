...
const cookiesCopy: Record<string, {
  ...
  de: {
    ...
    sections: [
      { heading: '1. Einleitung', paragraphs: ['Unsere Website, https://doisense.app (nachfolgend „die Website"), verwendet Cookies und ähnliche Technologien (alle Technologien werden nachfolgend als „Cookies" bezeichnet). Cookies werden auch von Dritten gesetzt, mit denen wir zusammenarbeiten. Im folgenden Dokument informieren wir Sie darüber, wie wir Cookies auf unserer Website verwenden.'] },
  ...
  es: {
    ...
    sections: [
      { heading: '1. Introducción', paragraphs: ['Nuestro sitio web, https://doisense.app (en adelante "el sitio"), utiliza cookies y otras tecnologías similares (todas las tecnologías se denominan en adelante "cookies"). Las cookies también son colocadas por terceros con quienes colaboramos. En el documento a continuación le informamos sobre cómo utilizamos cookies en nuestro sitio.'] },
  ...
  pl: {
    ...
    sections: [
      { heading: '1. Wprowadzenie', paragraphs: ['Nasza strona internetowa, https://doisense.app (zwana dalej „stroną"), używa plików cookie i innych podobnych technologii (wszystkie technologie są dalej nazywane „plikami cookie"). Pliki cookie są też umieszczane przez strony trzecie, z którymi współpracujemy. W poniższym dokumencie informujemy o sposobie, w jaki używamy plików cookie na naszej stronie.'] },
