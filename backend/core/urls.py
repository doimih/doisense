...
urlpatterns = [
    ...
    path(
        "cms/preview/<slug:slug>", views.CMSPublicPreviewPageView.as_view(), name="cms-page-preview"
    ),
    ...
    path(
        ...
        views.InAppNotificationReadView.as_view(),
    ...
    path(
        ...
        views.SupportTicketAdminListView.as_view(),
        name="support-admin-tickets",
    ),
    path(
        "backup/restore-requests",
        views.BackupRestoreRequestView.as_view(),
        name="backup-restore-requests",
    ),
    path("analytics/funnel", views.AnalyticsFunnelView.as_view(), name="analytics-funnel"),
    path(
        "analytics/cohorts", views.AnalyticsCohortRetentionView.as_view(), name="analytics-cohorts"
    ),
