...
class TaskCreateUpdateSerializer(serializers.Serializer):
    ...
    duration_minutes = serializers.IntegerField(min_value=5, max_value=600, required=False, default=15)
    frequency = serializers.ChoiceField(choices=[item[0] for item in Task.FREQUENCY_CHOICES], required=False, default=Task.FREQ_DAILY)
    ...
    reminder_minutes_before = serializers.IntegerField(min_value=0, max_value=1440, required=False, default=10)
