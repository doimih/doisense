...
_CATALOG: dict[str, list[tuple[str, str, int, str]]] = {
    "wellness": [
        ...
        (
            "Respira si recentreaza-te",
            "Respiratie constienta pentru claritate mentala.",
            7,
            "basic",
        ),
        ...
        (
            "Reset anti-stres",
            "Strategii practice pentru reducerea stresului cotidian.",
            14,
            "premium",
        ),
    ...
    "coaching": [
        ...
        (
            "Rutina de performanta",
            "Structura zilnica pentru lucru profund si pauze utile.",
            21,
            "premium",
        ),
        ...
        (
            "Sprint de transformare",
            "Executie ghidata cu revizuire si optimizare zilnica.",
            30,
            "vip",
        ),
    ...
    "educatie": [
        (
            "Bazele reglajului emotional",
            "Intelegi mecanisme simple ale starii emotionale.",
            7,
            "basic",
        ),
        (
            "Cum functioneaza obiceiurile",
            "Inveti bucla obiceiurilor si cum o folosesti in favoarea ta.",
            10,
            "basic",
        ),
        ("ABC-ul mindfulness", "Fundamente practice pentru prezenta si atentie.", 7, "basic"),
        (
            "Neuroplasticitate aplicata",
            "Inveti cum schimbi tipare prin repetitie constienta.",
            14,
            "premium",
        ),
    ...
    "suport": [
        (
            "Revenire dupa zile grele",
            "Pasi blanzi pentru stabilizare dupa perioade solicitante.",
            7,
            "basic",
        ),
        ...
        (
            "Suport emotional zilnic",
            "Micro-check-in-uri si exercitii pentru reglaj constant.",
            14,
            "premium",
        ),
        ...
        (
            "Stabilitate relationala",
            "Exersezi raspunsuri si pauze utile in relatii.",
            14,
            "premium",
        ),
        ...
        (
            "Calm architecture",
            "Reconstruiesti stabilitatea prin pași zilnici foarte clari.",
            30,
            "vip",
        ),
    ],
